                            ...
                            return (
                              <>
                                <ListItem key={blog._id} divider>
                                  ...
                                  <Typography><p><bold>Artist: </bold>{blog.artist}</p></Typography>
                                </ListItem>
                                <ListItem button>
                                  <ListItemText id="bookTitle" className="readBlogs" />
                                  <Typography><p><bold>Name: </bold>{blog.blogger}</p></Typography>
                                </ListItem>
                                <ListItem button>
                                  <ListItemText id="bookRating" className="readBlogs" />
                                  <Typography><p><bold>Rating: </bold>{blog.rating}</p></Typography>
                                </ListItem>
                                <ListItem button>
                                  <ListItemText id="bookBlog" className="readBlogs" />
                                  <Typography><p><bold>Comment: </bold>{blog.blog}</p></Typography>
                                </ListItem>
                                </>
                            );
                          })}
